 ...
 *
 */
public abstract class ProviderTensorTestBase<V extends ProviderTensor<V, D> & AutogradValue<V, D, Size>, D> {
    ...
    protected abstract V createGradValue(float value, boolean requires_grad);
   
    protected abstract V createGradValue(D value, boolean requires_grad);
